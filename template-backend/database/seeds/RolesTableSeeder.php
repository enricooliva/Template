...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role = Role::create(['name' => 'op_approvazione'])
            ->givePermissionTo(['search all contratti','search all insegnamenti','update contratti', 'sending infoemail', 'sending firstemail']);
        ...
        $role = Role::create(['name' => 'op_approvazione_amm'])
            ->givePermissionTo(['search all contratti','search all insegnamenti','update contratti', 'validazioneamm precontrattuale', 
                'annullaamm precontrattuale', 'sending infoemail', 'sending firstemail']);
